...
export default async function EventDetails({
  ...
  const hasEventStarted =
    event.startDateTime.getTime() - new Date().getTime() < 0;
    ...
    <>
      <section>
        ...
        <div className="mb-5">
          ...
          {!hasEventStarted && !isRegistered && (
            <Card className="rounded-md overflow-hidden">
              ...
              <CardContent className="py-2 px-3">
                <p className="mb-4">
                  Welcome! This event is free to attend. Please register to get
                  access to the event.
                </p>
          ...
          {!hasEventStarted && isRegistered && (
            <div>
              <Card className="rounded-md overflow-hidden">
                ...
                <CardContent className="py-2 px-3">
                  <p className="mb-4">
                    You're registered for this event. We'll send you an email
                    with the details.
                  </p>
                  ...
                  <div>
                    <p>
                      ...
                      <Link
                        className="underline"
                        href={`/event/${event.id}/unregister`}
                      >
                        Unregister
                      </Link>
                    </p>
          ...
          {hasEventStarted && !hasEventEnded && !isRegistered && (
            <div>
              <Card className="rounded-md overflow-hidden">
                <CardHeader className="p-2 px-3 bg-gray-300">
                  <CardTitle className="text-base font-medium">
                ...
                <CardContent className="py-2 px-3">
                  <p className="">This event has started.</p>
                </CardContent>
              </Card>
            </div>
          )}
              ...
              <Card className="rounded-md overflow-hidden">
                ...
                <CardContent className="py-2 px-3">
                  ...
                  <div>
                    <p>
                      No longer able to attend?{' '}
                      <Link href={`/event/${event.id}/unregister`}>
                        Unregister
                      </Link>
                    </p>
                  </div>
