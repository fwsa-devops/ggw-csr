      ...
      <div className="overflow-hidden bg-white pt-10 sm:pt-32"> 
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start">
            ...
            <div className="order-1 lg:order-2 lg:pr-4 lg:pt-4">
              <div className="lg:max-w-lg">
                ...
                <h2 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Education</h2>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 mb-24">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start">
            <div className="lg:pr-4 lg:pt-4">
              <div className="lg:max-w-lg">
                <h2 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Community</h2>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  ...
                  We promote gender equality, provide homes for women and orphans, and support the elderly. Our mission includes reducing social and economic inequalities.
                </p>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  For
                  <span className="mx-1.5 font-bold" >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 mb-24">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start">
            ...
            <div className="order-1 lg:order-2 lg:pr-4 lg:pt-4">
              <div className="lg:max-w-lg">
                <h2 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Environment</h2>
                <p className="mt-6 text-lg leading-8 text-gray-600">
