...
const ActiveEvents = (props) => {
  ...
  const onDateChange = async (value) => {
    ...
    return await getFilteredActivitiesBasedOnTime(value);
  };

  const onLocationChange = (item, value) => {
    const target = locations.map((obj) =>
  ...
  return (
    <>
      <div className="flex justify-end">
        ...
        />
        <DatePickerWithRange onUpdate={onDateChange} />
      </div>
