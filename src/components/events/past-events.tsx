                ...
                <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <p className="leading-relaxed mb-3">
                      {activity.description.slice(PAST_EVENTS_DESCRIPTION_TEXT_LENGTH)}
                    </p>
              ...
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="leading-relaxed mb-3">
                    ...
                    distinctio dignissimos reprehenderit, delectus fugit?
                    Laboriosam, illo! Mollitia consectetur doloremque, cumque
                    sequi harum totam repellat!
                  </p>
                  <div className="flex items-center flex-wrap ">
                    <a className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">
                      Learn More
