...
export default function Example() {
  ...
  const isActivePath = (path: string) => {
    return pathname.split('/')[0].toLocaleLowerCase() === path.toLocaleLowerCase()
  }
                    ...
                    <Link
                      ...
                      className={
                        cn(
                          ...
                          isActivePath(nav.href) ? "border-indigo-500 text-gray-900" : "border-transparent text-gray-500  hover:text-gray-700"
                        )
                      }
                    >
                      {nav.name}
